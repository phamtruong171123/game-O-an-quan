...
public class GameOver extends JFrame implements IFrame, Interface_GameOver {
	...
	public void result(List<IPlayer> list) {
		...
		lbPlayer1.setText("Winner: "+ list.get(0).getName() + " : " + list.get(0).getScore());
		lbPlayer2.setText(list.get(1).getName() + " : " + list.get(1).getScore());}
	else if(list.get(0).getScore()<list.get(1).getScore()){
	
		
		lbPlayer1.setText("Winner: "+ list.get(1).getName() + " : " + list.get(1).getScore());
		lbPlayer2.setText(list.get(0).getName() + " : " + list.get(0).getScore());}
}
}