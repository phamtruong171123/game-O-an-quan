...
public class BoardView extends JFrame
	...
	public void init() {
		...
		panel_2_1.setLayout(new GridLayout(1, 8, 5, 5));
		...
		JLabel lblNewLabel_1 = new JLabel("Còn lại:");
		...
		panel_10.setOpaque(false);
		panel_4_1.add(panel_10);
		panel_10_2.setVisible(false);

		panel_4_1.add(panel_10_1);
		...
		btLeft_1.setVisible(false);
		btRight_1.setVisible(false);
		btLeft_2.setVisible(false);
		
		btRight_2.setVisible(false);
	...
	public void event(int index) {
		z = 1; // để chỉ thực hiện 1 lần
		if (index > 0 && index < 6) {
			listButton.get(index).addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					// TODO Auto-generated method stub
					btLeft_1.setVisible(true);
					btRight_1.setVisible(true);
...

		{
			listButton.get(index).addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					// TODO Auto-generated method stub
					btLeft_2.setVisible(true);
					btRight_2.setVisible(true);
	...
	public void turnOver(boolean turn) {
		if (turn) {
			...
			for (int i = 1; i < 6; i++) {
				...
				if(listButton.get(i).getText().equals("    "+0+"    ")) {listButton.get(i).setEnabled(false);}
	...
	public void updateStone(int index, int stone) {
		// TODO Auto-generated method stub
		if (index == 0 || index == 6) {
			listButton.get(index).setText("       "+ String.valueOf(stone) +"      ");
		} else {
			listButton.get(index).setText( "    "+ String.valueOf(stone) +"    " );
		}
	}
